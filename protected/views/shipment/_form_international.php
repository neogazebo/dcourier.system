<div class="form">
			...
			<div class="subcr">
				...
				<div class="row at_comp">
					...
					$this->widget('zii.widgets.jui.CJuiAutoComplete', array(
						...
						'options' => array(
							'select' => 'js:function(event,ui){
									$("#ShipmentInternational_zone").val(ui.item.zone);
									return true;
								}',
						)
							)
				...
				<?php echo $form->hiddenField($model_international, 'zone'); ?>
	...
	<div class="subcolumns">
		<div class="c50l">
			<div class="row">
				...
				<div id="status-radiobutton">
					<?php echo $form->radioButtonList($model, 'type', $model->listtype, array('class' => 'typ')); ?>
				</div>
		...
		<div class="c501r">
			...
			<div class="row buttons">
				<?php
				echo CHtml::ajaxButton('View Available Service', array('shipment/InternationalService'), array(
					'type' => 'post',
					'dataType' => 'html',
					'data' => 'js:$("input#ShipmentInternational_zone").serialize()+"&"+$("input[name*=ShipmentItem]").serialize()+"&"+$("input.typ").serialize()',
					'success' => 'js:function(data){
