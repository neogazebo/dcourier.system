 ...
 * @property string $nip
 * @property string $telp_home
 * @property string $telp_office
...
//				array('oldPassword','CUpdatePasswordValidator','newPasswordAttribute'=>'newPassword','savedPasswordAttribute'=>'password'),
				array('confirmPassword','compare','compareAttribute'=>'newPassword','message'=>'{compareAttribute} harus diulang dengan tepat'),
...
//		CVarDumper::dump($this->poto);exit;
		return true;
	}
}